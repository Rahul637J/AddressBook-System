...
class AddressBook:
    ...
    def display_contacts(self, sort_by='first_name'):
        ...
        Parameters:
            sort_by (str): The field to sort contacts by. Options are 'first_name' or 'last_name'. Default is 'first_name'.
    ...
    while True:
        try:
            ...
            if option == 1:
                ...
                print(manager.display_all_address_books())
                addressBook_name = input("Enter address book name: ")
                sort_option = input("Sort by 1. First Name 2. Last Name: ")
                sort_by = 'first_name' if sort_option == '1' else 'last_name'
