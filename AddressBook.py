...
class AddressBookManager:
    ...
    def create_address_book(self, addressBook_name):
        ...
        Parameters:
            addressBook_name (str): The name of the address book to create.
    ...
    while True:
        try:
            ...
            if option == 1:
                ...
                print(manager.display_all_address_books())
                addressBook_name = input("Enter address book name: ")
                sort_option = input("Sort by 1. First Name 2. Last Name 3. City 4. State 5. Zip: ")
                sort_by = 'first_name' if sort_option == '1' else \
                          'last_name' if sort_option == '2' else \
                          'city' if sort_option == '3' else \
                          'state' if sort_option == '4' else \
                          'zip' if sort_option == '5' else 'first_name'
